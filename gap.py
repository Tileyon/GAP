...
def build_obj(obj, disp):
    ...
    string_out = '(' + obj_type + ", (" + \
        str(round(((obj.x - (12  * mypage.xratio)) / mypage.xratio * 4/3 * 7/8) - 0)) + \
        ', ' + fix(round((obj.y - (80 * mypage.yratio)) / mypage.yratio * 4/3 * 7/8), round(obj.height  / mypage.yratio* 4/3 * 7/8)) + ', ' \
        + str(round(obj.width / mypage.xratio * 4/3 * 7/8)) + ', ' + str(round(obj.height  / mypage.yratio * 4/3 * 7/8))
